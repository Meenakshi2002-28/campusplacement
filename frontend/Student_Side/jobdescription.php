...
<div class="main-content">
    <div class="job-details">
        ...
        <div class="jobimg">
            ...
            <a href="#briefcase"><i class="fa fa-fw fa-solid fa-briefcase"></i> Full Time</a>
            <a href="#salary"><i class="fas fa-rupee-sign"></i><?php echo htmlspecialchars($jobDetails[0]['salary']); ?></a>
            <a href="#calendar"><i class="fa fa-fw fa-solid fa-calendar"></i> Apply By <?php echo htmlspecialchars($jobDetails[0]['application_deadline']); ?></a>
        </div>
    ...
    <div class="eligibility-section">
        <form>
            <div class="eligibility-1">
                ...
                <input type="text" id="10th" name="10th" value="<?php echo htmlspecialchars($jobDetails[0]['tenth_requirement']); ?>" readonly>

                <label for="12th">12th</label>
                <input type="text" id="12th" name="12th" value="<?php echo htmlspecialchars($jobDetails[0]['tweflth_requirement']); ?>" readonly>
    ...
    <div class="job-description">
        <h4>Description</h4>
        <p><?php echo htmlspecialchars($jobDetails[0]['description']); ?></p>
    </div>
