...
<body>
    ...
    <div class="main-content">
        ...
        <div id="personal" class="details active">
            <form action="admineditpersonal.php" method="post">
                <input type="hidden" name="user_id" value="<?php echo htmlspecialchars($user_id); ?>"> <!-- Change action to point to the view details script -->
                <table>
                    <tr>
                        <td>Branch:</td>
                        <td>
                            <input type="text" name="course_branch" value="<?php echo htmlspecialchars($course_branch); ?>" readonly/>
                        </td>
                    </tr>
                    <tr>
                        <td>Course </td>
                        <td>
                            <input type="text" name="course_name" value="<?php echo htmlspecialchars($course_name); ?>"readonly />
                        </td>
                    </tr>
                    <tr>
                        <td>Current Year </td>
                        <td>
                            <input type="text" name="current_year" value="<?php echo htmlspecialchars($current_year); ?>"readonly />
                        </td>
                    </tr>
                    <tr>
                        <td>Pass Out Year </td>
                        <td>
                            <input type="text" name="graduation_year" value="<?php echo htmlspecialchars($graduation_year); ?>" readonly/>
                        </td>
                    </tr>
                    <tr>
                        <td>Gender </td>
                    ...
                    <tr>
                        <td>Date of Birth:</td>
                        <td>
                            <input type="date" name="dob" value="<?php echo htmlspecialchars($dob); ?>" readonly/>
                        </td>
                    </tr>
                </table>
                ...
                <table>
                    <tr>
                        <td>Phone Number </td>
                        <td>
                            <input type="text" id="number" name="phone_number" value="<?php echo htmlspecialchars($phone_number); ?>" readonly/>
                        </td>
                    </tr>
                    <tr>
                        <td>Email </td>
